...
output-file: "2024-12-14 Nat'l Multivar by Zone and Plot"
date: today
format: 
    html:
        toc: true
...
Latest update: 12-3-24 - making a separate NMDS plot for each region, in plot-level section. rendered output file on 12-14-24.
